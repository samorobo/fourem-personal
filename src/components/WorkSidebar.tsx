...
//   return (
//     <aside
//       className={`hidden lg:block fixed left-0 top-0 h-screen bg-[#E8E8E8] z-40 transition-all duration-300 ease-in-out ${
...
//               className="text-left text-[16px] hover:opacity-70 transition-opacity"
//               style={{ 
//                 fontFamily: '"Times New Roman", Times, serif',
//                 color: '#3C3C34',
//                 fontWeight: 400,
